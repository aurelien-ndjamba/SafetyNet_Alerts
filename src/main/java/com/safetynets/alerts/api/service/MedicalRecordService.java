...
public class MedicalRecordService {
	...
	/**
	 * Filtre un enregistrement médical dans la base de donnée ayant l'id en
	 * paramètre
	 * 
	 * @Param long id
	...
	/**
	 * Filtre des enregistrements médicaux dans la base de donnée ayant le même nom
	 * en paramètre
	 * 
	...
	/**
	 * Filtre un enregistrement médical dans la base de donnée à partir de son
	 * prénom et nom en paramètre
	 * 
	 ...
	 * @return MedicalRecord -> le nouvel enregistrement avec son id dans la base de
	 *         donnée
	 * 
	 */
	...
	/**
	 * Met à jour un enregistrement medical dans la base de donnée Le prénom et le
	 * nom ne peuvent pas être modifiable
	 * 
	 * @param MedicalRecordModel medicalRecord
	 * @return MedicalRecordModel
	 * 
	...
	public MedicalRecordModel update(MedicalRecordModel medicalRecord) {
		...
		MedicalRecordInDb = medicalRecordRepository.findByFirstNameAndLastName(medicalRecord.getFirstName(),
	...
	/**
	 * Supprime un enregistrement medical dans la base de donnée à partir de son
	 * prénom et son nom
	 * 
	 * @Param String firstname
	 * @Param String lastname
